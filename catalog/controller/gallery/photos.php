    ...
    private function section_photos($album_id){
        ...
        if (!empty($this->cacher) && $this->config->get('config_gallery_modules_cache_enabled')) {
            ...
            $album['bootstrap_grid'] = implode(' ', array(
                (isset($album['album_data']['number_of_columns_xs']) && (int)$album['album_data']['number_of_columns_xs'] !== 0) ? 'col-xs-'.$bootstrap_columns[$album['album_data']['number_of_columns_xs']] : '',
                (isset($album['album_data']['number_of_columns_sm']) && (int)$album['album_data']['number_of_columns_sm'] !== 0) ? 'col-sm-'.$bootstrap_columns[$album['album_data']['number_of_columns_sm']] : '',
                (isset($album['album_data']['number_of_columns_md']) && (int)$album['album_data']['number_of_columns_md'] !== 0) ? 'col-md-'.$bootstrap_columns[$album['album_data']['number_of_columns_md']] : '',
                (isset($album['album_data']['number_of_columns_lg']) && (int)$album['album_data']['number_of_columns_lg'] !== 0) ? 'col-lg-'.$bootstrap_columns[$album['album_data']['number_of_columns_lg']] : ''
            ));
