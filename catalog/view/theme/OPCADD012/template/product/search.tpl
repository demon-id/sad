...
<div class="container">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <label class="control-label search-title" for="input-search"><?php echo $entry_search; ?></label>
      ...
      <div class="row">
        ...
        <div class="col-sm-6 sort search-category">
        ...
        <div class="col-sm-12 search-checkbox">
      ...
      <h2 class="product-meeting"><?php echo $text_search; ?></h2>
      <?php if ($products) { ?>
