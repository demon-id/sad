...
<?php echo $footertop; ?>
<div class="content_footer_leftcol">  <div class="col-sm-3 column"><?php echo $footerleftcol; ?> </div></div>
</div></div>
  ...
  <div id="footer" class="container">
    ...
    <?php /*?>  <div class="col-sm-3 column">
	  ...
	  <div class=" column content_footer_right"><?php echo $footerright; ?> </div>
