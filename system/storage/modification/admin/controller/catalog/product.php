...
class ControllerCatalogProduct extends Controller {
	...
	protected function getForm() {
		...
		if (isset($this->request->get['product_id'])) {
			$article_path = $this->model_catalog_article->getPathArticleToProduct($this->request->get['product_id']);
		} else {
			$article_path = '';
		}
		...
		$article_product = $this->model_catalog_article->getPath($data['article_parent_id']);

		if (isset($this->request->post['article_path'])) {
			$data['article_path'] = $this->request->post['article_path'];
		} elseif (!empty($article_product)) {
			$data['article_path'] = $article_product;
		} else {
			$data['article_path'] = '';
		}
