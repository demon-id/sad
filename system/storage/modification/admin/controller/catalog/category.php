...
class ControllerCatalogCategory extends Controller {
	...
	protected function getForm() {
		...
		$data['entry_article_parent'] = $this->language->get('entry_article_parent');
		...
		$data['help_article_parent'] = $this->language->get('help_article_parent');
		...
		if (isset($this->request->get['category_id'])) {
			$article_path = $this->model_catalog_article->getPathArticleToCategory($this->request->get['category_id']);
		} else {
			$article_path = '';
		}

		if (isset($this->request->post['article_parent_id'])) {
			$data['article_parent_id'] = $this->request->post['article_parent_id'];
		} elseif (!empty($article_path)) {
			$data['article_parent_id'] = $article_path['article_id'];
		} else {
			$data['article_parent_id'] = 0;
		}

		$article_category = $this->model_catalog_article->getPath($data['article_parent_id']);

		if (isset($this->request->post['article_path'])) {
			$data['article_path'] = $this->request->post['article_path'];
		} elseif (!empty($article_category)) {
			$data['article_path'] = $article_category;
		} else {
			$data['article_path'] = '';
		}
