  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <button type="submit" form="form-latest-articles" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>
  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-latest-articles" class="form-horizontal">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="module_type" id="input-module-type" class="form-control">
                <?php foreach ($article_module_types as $type_id => $name) { ?>
                <?php if ($type_id == $module_type) { ?>
 	...
 	<div class="form-group select_category">
 	   <label class="col-sm-2 control-label" for="input-parent"><span data-toggle="tooltip" title="<?php echo $help_parent; ?>"><?php echo $entry_parent; ?></span></label>
	 	...
	 	<input type="hidden" name="parent_id" value="<?php echo $parent_id; ?>" />
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-show-date"><?php echo $entry_show_date; ?></label>
            <div class="col-sm-10">
...
$(document).ready(function(){
	if ($('#input-module-type option:selected').val() == 1) {
		$('div.select_category').show();
	}else{ 
		$('div.select_category').hide();
	}
});
